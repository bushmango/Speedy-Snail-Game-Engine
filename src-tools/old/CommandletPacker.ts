...
function pack(inPath, outPath, outJson, outPng) {
  ...
  let args = `--data ${outPath + outJson} --format json --sheet ${outPath +
    outPng} --force-squared --scale 4 --scale-mode fast --width 512 --height 512 --border-padding 2 --shape-padding 2 --inner-padding 2 --trim-sprite-names --disable-rotation ${inPath}`
