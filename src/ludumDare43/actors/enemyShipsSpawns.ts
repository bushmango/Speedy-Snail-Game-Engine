...
export function spawn5() {
  ...
  //attachNewPart(c, 'engine-2', centerShipGridX - 1, centerShipGridY - 5)
  attachNewPart(c, 'laser-1', centerShipGridX - 1, centerShipGridY - 4, true)
  attachNewPart(c, 'laser-1', centerShipGridX - 1, centerShipGridY - 3, true)
  attachNewPart(c, 'laser-1', centerShipGridX - 1, centerShipGridY - 1, true)
  attachNewPart(c, 'engine-2', centerShipGridX - 1, centerShipGridY - 2)
  attachNewPart(c, 'cross', centerShipGridX - 0, centerShipGridY - 2, true)
  //attachNewPart(c, 'armor-1', centerShipGridX - 2, centerShipGridY - 2)
  attachNewPart(c, 'laser-1', centerShipGridX - 1, centerShipGridY + 1, true)
  attachNewPart(c, 'laser-1', centerShipGridX - 1, centerShipGridY + 3, true)
  attachNewPart(c, 'laser-1', centerShipGridX - 1, centerShipGridY + 4, true)
